...
public class Picture {
    ...
    public final VerticalParabola P = new VerticalParabola(0, -6, 0.25);
    public final Rectangle R = new Rectangle(new Point2D.Double(-6, -2), new Point2D.Double(-1, 4));
    public final Line L = new Line(-1, 2, -2);
